...
const MotorUseModal = ({ isModalOpen, onOkay, onCancel, motorUse }) => {
  ...
  const handleNavigate = () => {
    if (motorUse === "Private") {
      navigate("/home/motor-vehicle?use=private");
    } else if (motorUse === "Commercial") {
      navigate("/home/motor-vehicle?use=commercial");
    }
  };
