      ...
      <Card className={`border ${theme === "dark" ? "" : "border-black"}`}>
        <div style={{ width: "100%", margin: "auto" }}>
          ...
          <div style={{ marginBottom: "10px" }}>
            ...
            <p>
              3. For individual immediate annuities, spouse reversion should be
              indicated as 0% (zero).
            </p>
            <p>
              4. If an annuity has both a guarantee period and spouse reversion,
              should the main annuitant die before the guarantee period elapses,
              pension at the full rate will continue for the remainder of the
              guarantee period. The spouse reversion commences after the
              conclusion of the guarantee period.
            </p>
            <p>
              5. Should spouse details be unavailable or difficult to retrieve,
              for purposes of computing a spouse reversion, assume a 3 year age
              difference with the male life older than the female life.
            </p>
