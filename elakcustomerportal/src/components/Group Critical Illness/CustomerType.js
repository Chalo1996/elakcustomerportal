...
import IndividualCustomerModal from "./IndividualCustomerModal";
...
const CustomerType = () => {
  ...
  const handleNavigateCustomerPage = () => {
    navigate("critical-illness");
  };
            ...
            <div className="flex items-center justify-between w-[335px] h-[81px]">
              ...
              <div>
                <RightOutlined
                  className="text-[#A32A29]"
                  style={{ fontSize: "18px" }}
                  onClick={handleNavigateCustomerPage}
                />
              </div>
            </div>
